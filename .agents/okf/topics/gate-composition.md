...
- `GateAuthorSpec` (packages/core/src/workflow/gate-authoring.ts:144) — 12 callers in `packages/core/src/workflow/agent-base.ts`, `packages/core/src/workflow/gate-list.ts`, `packages/core/src/index.ts`, `packages/core/src/workflow/judge/materialize.ts` +1 more; tests: `packages/core/test/gate-authoring.test.ts`
