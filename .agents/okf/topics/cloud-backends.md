...
# Anchors
SELECT
- `packages/cli/src/run.ts:336` — `parseRunArgs` (`--sandbox`) — parse the backend choice (typo errors loudly)
...
- `54db24c` 2026-07-01 — refactor(deploy): single source of truth for the pi node-runtime image
...
- `CLOUD_KINDS` (packages/core/src/runner/env-staging.ts:23) — 4 callers in `packages/core/src/runner/node-lifecycle.ts`, `packages/core/src/runner/runner.ts`, `packages/core/src/runner/index.ts`, `packages/core/src/index.ts`; ⚠ no covering tests found
