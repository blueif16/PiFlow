...
- `scoreRun` (packages/core/src/optimize/score.ts:93) — 2 callers in `packages/core/src/index.ts`, `packages/core/src/optimize/index.ts`; ⚠ no covering tests found
...
<sub>derived 2026-07-21 · arc=30 commits · files=19 · lessons=51</sub>
<!-- okf:auto-end -->
