...
- `NodeSpec` (packages/core/src/types.ts:17) — 36 callers in `packages/core/src/dag.ts`, `packages/core/src/runner/drivers/types.ts`, `packages/core/src/runner/env-staging.ts`, `packages/core/src/runner/node-lifecycle.ts` +4 more; tests: `packages/core/test/claude-code-driver.test.ts`, `packages/core/test/driver-runtime.test.ts`, `packages/core/test/execcwd-staging.test.ts`, `packages/core/test/executor-override.test.ts` +3

<sub>derived 2026-07-03 · arc=69 commits · files=5 · lessons=32</sub>
<!-- okf:auto-end -->
