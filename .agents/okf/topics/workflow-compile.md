...
- `loadTemplate` (packages/core/src/workflow/template/loader.ts:273) — 20 callers in `packages/core/src/runner/entry.ts`, `packages/cli/src/run.ts`, `packages/core/src/optimize/substrate/child-run.ts`, `packages/server/src/handlers.ts` +1 more; tests: `packages/cli/test/node-rerun.test.ts`, `packages/cli/test/run.test.ts`, `packages/cli/test/scaffold.test.ts`, `packages/core/test/gate-list-profiles.test.ts` +4
