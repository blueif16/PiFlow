...
- `packages/core/src/runner/node-lifecycle.ts:1267` — `finishNode` — stamp the verdict into the run's `.pi/` tree + journal
...
<sub>derived 2026-07-17 · arc=175 commits · files=7 · lessons=12</sub>
<!-- okf:auto-end -->
