...
<task>Independently assess the subject and write your review to verify/review-a.json. You are ONE of several independent reviewers — do not coordinate; give your own honest verdict.</task>

<output_spec>Write ONLY this JSON to verify/review-a.json (no prose outside it):
{
  "verdict": "pass" | "fail",
  "confidence": 0.0,
  "issues": [
