...
// The DEFAULT set (authoring trio + the piflow-inspect instrument router) travels to a consumer repo BY
// DEFAULT — EXCLUDES piflow-release (SDK publishing) and piflow-web-design (marketing-site only). MIRROR
// DEFAULT_SKILLS in src/skills.ts.
const DEFAULT_SKILLS = ['piflow-init', 'piflow-start', 'piflow-enhance', 'piflow-inspect'];
